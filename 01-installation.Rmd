...
The **GloSIS database** services are provided as a **Docker container**, which allows users to deploy and manage the system without manually installing software dependencies. This approach ensures stability, compatibility, and easy updates.  
