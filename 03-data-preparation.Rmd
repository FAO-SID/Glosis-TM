...
As an illustration, the columns with red values in Figure \@ref(fig:specimen-tab) indicate soil parameters that required unit conversions to align with GloSIS standard units of measurement, compared to their original values (Figure \@ref(fig:original-tab)).
