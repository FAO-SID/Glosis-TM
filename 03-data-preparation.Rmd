...
```{r template, echo=FALSE, out.width="80%",fig.cap = "xlsx template."}
library(knitr)
...
```{r plot-tab, echo=FALSE, out.width="80%",fig.cap = "Information in the Plot_Data Tab."}
...
```{r specimen-tab, echo=FALSE, out.width="80%",fig.cap = "Information in the Specimen Data sheet."}
...
```{r codelist-tab, echo=FALSE, out.width="80%",fig.cap = "Properties, methods and units of measurement in the Codelist sheet"}
