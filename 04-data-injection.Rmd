...
## Delete an existing database. {#database-injection .#illustration}
...
```{r specimen-tab, echo=FALSE, out.width="100%",fig.cap = "Information in the Specimen Data sheet."}
