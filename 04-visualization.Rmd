...
```{r dashboardcreate, echo=FALSE, out.width="100%", fig.cap = "`Create Dashboard button` on the left panel of the data injection app."}
...
```{r dashboardgoto, echo=FALSE, out.width="100%", fig.cap = "`Go to Dashboard` button in <span style='color:green;'>green</span> color."}
knitr::include_graphics("figures/dashboard_goto.png")
```

Clicking this button opens a new tab displaying soil data, in `.html`format, in three sections (Figure \@ref(fig:dashboard1)):

-   **Location** -- Details about the position of the soil data points.\
-   **Attributes** -- Data on soil properties.\
-   **Boxplot** -- Histograms showing the distribution of soil properties across profiles and depths for quick visual comparisons.

```{r dashboard1, echo=FALSE, out.width="100%",fig.cap = "Visualization of the soil data in the dashboard.."}
...
```{r dashboard4, echo=FALSE, out.width="100%",fig.cap = "Boxplot visualization of filtered soil data attributes."}
...
```{r viewer, echo=FALSE, out.width="100%",fig.cap = "Visualization app."}
...
```{r viewer2, echo=FALSE, out.width="100%",fig.cap = "Visualization app showing soil data from the selected database."}
